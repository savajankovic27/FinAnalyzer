The primary goal of this project is to analyze the different datasets (such as stock prices, portfolio returns, revenues/expenses for a company) stored in .csv files. Throughout the project, I will:
